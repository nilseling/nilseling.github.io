...
\section{Employment}
\cventry{2024--present}{Senior Expert II Data Science}{Biomedical Research}{\textit{Novartis}}{}{}
\cventry{2023--2023}{Senior computational scientist}{DQBM/IMHS}{\textit{University of Zurich/ETH Zurich}}{}{}
...
\cventry{2024}{\textnormal{\textit{An end-to-end workflow for multiplexed image processing and analysis}}}{\textnormal{Windhager, J., Zanotelli, V.R.T, Schulz, D., Meyer, L., Daniel, M., Bodenmiller, B.*, \underline{Eling, N.*}}}{\textit{Nature Protocols}}{*Corresponding author}{}
...
\section{Conferences, workshops, certificates}

\subsection{Certificate}
\cvitem{2023}{EMBO Project Management}
\cvitem{2021}{EMBO Lab Leadership}
\cvitem{2016-2017}{Academy for PhD Training in Statistics}

\subsection{Talk}
\cvitem{2023}{Labex Signalife technological day (invited)}
...
\subsection{Poster}
\cvitem{2023}{Spatial Omics meeting Lausanne}
...
\subsection{Teaching}
\cvitem{2023}{Current Approaches in Single Cell Analysis - Spatial analysis of single cell data (BME327)}
\cvitem{2023}{Current Approaches in Single Cell Analysis - Single cell data extraction from multiplexed images (BME327)}
\cvitem{2023}{ETH/UZH PhD Program in Cancer Biology Module B - Multiplexed image analysis}
\cvitem{2023}{ETH/UZH PhD Program in Cancer Biology Module B - Multiplexed image analysis}
\cvitem{2023}{Highly Multiplexed Tissue Imaging Computational Workshop}
